...
namespace Serilog.Sinks.SpectreConsole.Tests.Output
{
    public class OutputTemplateRendererTests
    {
        ...
        public void UsesFormatProvider()
        {
            ...
            Assert.Equal("12,345", formatter.Format(evt).Render());
        }
        ...
        public void MessageTemplatesContainingFormatStringPropertiesRenderCorrectly()
        {
            ...
            Assert.Equal("\"Hello, world!\"", formatter.Format(evt).Render());
        }
        ...
        public void UppercaseFormatSpecifierIsSupportedForStrings()
        {
            ...
            Assert.Equal("NICK", formatter.Format(evt).Render());
        }
            ...
            string expected)
        {
            ...
            Assert.Equal(expected, formatter.Format(evt).Render());
        }
        ...
        public void FixedLengthLevelSupportsUpperCasing()
        {
            ...
            Assert.Equal("INF", formatter.Format(evt).Render());
        }
        ...
        public void DefaultLevelLengthIsFullText()
        {
            ...
            var evt = DelegatingSink.GetLogEvent(l => l.Information("Hello"));
            Assert.Equal("Information", formatter.Format(evt).Render());
        }
        ...
        public void AppliesCustomFormatterToEnums()
        {
            ...
            Assert.Equal("Size Huge", formatter.Format(evt).Render());
        }
        ...
        public void NonMessagePropertiesAreRendered()
        {
            ...
            Assert.Equal("{Foo=42}", formatter.Format(evt).Render());
        }
        ...
        public void DoNotDuplicatePropertiesAlreadyRenderedInOutputTemplate()
        {
            ...
            Assert.Equal("42 {Bar=42}", formatter.Format(evt).Render());
        }
        ...
        public void AnEmptyPropertiesTokenIsAnEmptyStructureValue()
        {
            ...
            // Assert.Equal(expected, formatter.Format(evt).Render());
            //
            Assert.Equal("{}", formatter.Format(evt).Render());
        }
        ...
        public void FormatProviderWithScalarProperties(string format, bool shouldUseCustomFormatter)
        {
            ...
            Assert.Contains(expectedFormattedDate, formatter.Format(evt).Render());
            Assert.Contains(expectedFormattedNumber, formatter.Format(evt).Render());
        }
